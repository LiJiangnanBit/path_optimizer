...
int main(int argc, char **argv) {
    ...
    while (nh.ok()) {
        ...
        // Calculate.
        std::vector<PathOptimizationNS::State> result_path, smoothed_reference_path, result_trajectory;
...
//            }
            ...
            trajectory_optimizer.solve(&result_trajectory);
        }
        ...
        for (size_t i = 0; i != result_trajectory.size(); ++i) {
            ...
            p4.x = -1.0;
            p4.y = 1;
            auto tmp_relto = result_trajectory[i];
            tmp_relto.z = heading;
